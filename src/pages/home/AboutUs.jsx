                ...
                <div className="container">
                    <div className="row">
                        <div className="col-sm-12 col-md-6">
                            ...
                            <p className='text-white-50' style={{ fontSize: "12px", fontFamily: "sans-serif" }} data-aos="fade-up">IS AN INTEGRATED MARKETING SOLUTIONS AGENCY THAT PROVIDES OUTSTANDING AND EFFECTIVE SERVICES TO HELP GROW YOUR BUSINESS AND ACHIEVE OBJECTIVES, INCREASE YOUR BRAND VALUE AND AWARENESS.</p>
                        </div>
                        <div className="col-sm-12 col-md-6">
                    ...
                    <div className="row">
                        <div className="about-box position-relative m-auto" style={{ width: "fit-content" }}>
                            ...
                            <p className='about-info Who text-white' style={{ backgroundColor: "#ad2026" }} data-aos="fade-up-right">Who are we</p>
